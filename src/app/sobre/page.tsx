  ...
  return (
    <div className="bg-zinc-900 text-white min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-center text-4xl font-bold mb-8"><span className="text-blue-500">Sobre </span>Mim</h1>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1">
            ...
            <a
              href="/Alexsandro-Developer.pdf" // Substitua pelo caminho do seu currículo
              download
